import 'package:app_food/pages/restaurant/tabs/menu_tab.dart';
import 'package:app_food/pages/restaurant/tabs/reservation_tab.dart';
import 'package:app_food/pages/restaurant/tabs/reviews_tab.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [ReservationTab(), MenuTab(), ReviewsTab()],
              ),
            )
          ],
        ),
